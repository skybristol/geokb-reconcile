...
service_name = 'GeoKB Reconciler'

# URL (without the trailing slash) where this server runs
this_host = 'https://reconcile.datadistillery.org'
...
# Width requested from Commons for the thumbnail
thumbnail_width = 130
